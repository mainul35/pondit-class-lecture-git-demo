                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                <a class="btn btn-success btn-lg btn-block"
                                   ...
                                   role="button">ADD</a> <a
                                    class="btn btn-primary btn-lg btn-block"
                                    href="${pageContext.request.contextPath }/student/show-all"
                                    role="button">SHOW ALL</a>
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-sm-12">
                    <div class="card mb-2">
                        <div class="card-body">
                            ...
                            <a href="${pageContext.request.contextPath}/search-page" class="btn-primary">Search Page</a>
                            ...
                            <a class="btn btn-primary btn-lg btn-block"
                               href="course/show-all" role="button">SHOW ALL</a>
                            </p>
                        </div>
                    </div>
                </div>
